...
<ul
  id="keyboard"
  on:mousedown={(e) => onMouseDown(e.target.getAttribute("note"))}
  on:mouseup={onMouseUp}
>
  <li note="C-2" class="white" />
  <li note="C#2" class="black" />
  <li note="D-2" class="white offset" />
  <li note="D#2" class="black" />
  <li note="E-2" class="white offset" />
  <li note="F-2" class="white" />
  <li note="F#2" class="black" />
  <li note="G-2" class="white offset" />
  <li note="G#2" class="black" />
  <li note="A-2" class="white offset" />
  <li note="A#2" class="black" />
  <li note="B-2" class="white offset" />
  <li note="C-3" class="white" />
  <li note="C#3" class="black" />
  <li note="D-3" class="white offset" />
  <li note="D#3" class="black" />
  <li note="E-3" class="white offset" />
</ul>
